				...
				flipUpper.addEvents({
					'complete': function(){
						...
						function hockeyClock(){
							...
							if(d != d_current){
								flipDate('dateUp', 'dateDown', d, './images/faces/upper/', './images/faces/lower/');
								d_current = d;
							}
							...
							if( h != h_current){
								flip('hoursUp', 'hoursDown', h, './images/faces/upper/', './images/faces/lower/');
								h_current = h;
							}

							if( m != m_current){
								flip('minutesUp', 'minutesDown', m, './images/faces/upper/', './images/faces/lower/');
								m_current = m;
							}


							if (s != s_current){
								flip('secondsUp', 'secondsDown', s, './images/faces/upper/', './images/faces/lower/');
								s_current = s;
							}
